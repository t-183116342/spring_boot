...
<html>
	...
	<body>
		<div class="panel admin-panel">
			<div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加资源</strong></div>
			<div class="body-content">
				...
				<form id="form1" method="post" class="form-x" action="cdsacdas">
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="" name="resourceName" data-validate="required:请输入部门名称" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="" name="resourceUrl" data-validate="required:请输入部门描述" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="field">
							<input type="text" class="input w50" value="" name="resourceDescription" data-validate="required:请输入部门描述" />
							<div class="tips"></div>
						</div>
					</div>
					<div class="form-group">
