			...
			<div class="panel admin-panel">
				...
				<div class="padding border-bottom">
					<ul class="search" style="padding-left:10px;">
						<li> <a class="button border-main icon-plus-square-o" href="/authority/addResourcePage"> 增加</a> </li>
					</ul>
				</div>
				...
				<table class="table table-hover text-center">
					<thead>
						<tr>
					        ...
					        <th width="300" style="text-align:center;">Url</th>
				...
				success : function(result) {
					...
					if(tl.list.length>0){
						$.each(tl.list, function(n,val){
							...
							var str="";
						    str+="<tr>";
						    str+="<td>"+getDefaultString(val.resourceId)+"</td>"
						    str+="<td>"+getDefaultString(val.resourceName)+"</td>"
						    str+="<td>"+getDefaultString(val.resourceUrl)+"</td>"
						    str+="<td>"+getDefaultString(val.resourceDescription)+"</td>"
						    str+="<td><div class='button-group'><a class='button border-main' href='/authority/editResourcePage?resourceId=" + val.resourceId + "'><span class='icon-edit'></span>修改</a><a class='button border-red' href='javascript:void(0)' onclick='del(" + val.resourceId + ")'><span class='icon-trash-o'></span>删除</a></div></td>"
						    str+="</tr>";
